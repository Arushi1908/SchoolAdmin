...
import { calculateDayWiseAttendancePercentage } from '../../../components/newCalculator';  // Import day-wise calculation function
...
const NewViewStudent = () => {
    ...
    // New day-wise attendance calculation
    const overallAttendancePercentage = calculateDayWiseAttendancePercentage(subjectAttendance);
        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    {/* <Button variant="contained" sx={styles.attendanceButton} onClick={() => navigate("/Admin/students/student/attendance/" + studentID)}>
                        Add Attendance
                    </Button> */}
                </>
            )
